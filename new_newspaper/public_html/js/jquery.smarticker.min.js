...
if (r.category == false && r.subcategory == false && r.titlesection == true){e(".smarticker-news", n).removeClass("sec7").addClass("sec10"); a.prependTo(n).text(r.title)}
...
function N(e){if (r.developerMode == true){console.log(e)}}
var n = e(this); var i = e('<div class="smarticker-cats"><ul></ul></div>'); var s = e('<div class="smarticker-category end_news_title"><ul></ul></div>'); r.newsRollerIndex = r.startindex; var o = e('<div class="smart-controller"><span class="prev-news">Previous</span><span class="pause-news">Pause</span><span class="next-news">Next</span></div>').css("background", n.css("background")); var u = e('<div class="progress-bar"></div>'); var a = e('<div class="sec1-2 tickertitle"></div>'); var f = e("li", n); e("li", n).css("display", "none"); if (e.trim(r.rssFeed) != ""){n.append('<div class="loading" Style="text-align:center;color:#666;font-size:12px">Loading Rss feed, Please wait ...</div>'); var l = r.rssFeed.split(","); var c = []; var h = []; var p = []; if (r.rssCats)h = r.rssCats.split(","); if (r.rssSources)c = r.rssSources.split(","); if (r.rssColors)p = r.rssColors.split(","); if (r.imagesPath[r.imagesPath.length - 1] != "/" && r.imagesPath != "")r.imagesPath = r.imagesPath + "/"; var d = 0; function v(){return false; var t = e.trim(l[d]); if (r.category != false){if (c[d] != undefined){c[d] = 'data-category="' + c[d] + '"'} else{c[d] = 'data-category="Rss"'}} else{c[d] = ""}
